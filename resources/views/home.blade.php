            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        ...
                        <a href="{{ route('queue.tree') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-danger card-outline">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                @forelse($deadDevices as $device)
                                    <li class="list-group-item list-group-item-danger">
                                        {{ $device->name }} ({{ $device->ip_address }}) - <strong>OFFLINE</strong>
                                    </li>
                                @empty
                                ...
                                <div class="col-md-6">
                                    <select id="deviceSelect" class="form-control">
                                        ...
                                        @foreach($devices as $device)
                                            <option value="{{ $device->name }}">{{ $device->name }} ({{ $device->ip_address }})</option>
                                        @endforeach
                                    </select>
                                </div>
...
devices.forEach(device => {
    ...
    markers[device.ip_address] = marker;

    searchList.push(device.name, device.ip_address);
});
