        ...
        <div class="container-fluid">
                              ...
                              <tr>
                                ...
                                <td>
                                  @php
                                    ...
                                    if (!empty($aktif)) {
                                      foreach ($aktif as $a) {
                                        if (isset($a['user']) && $a['user'] == $username) {
                                          $isActive = true;
                                          break;
                                        }
                                      }
            ...
            <div class="row">
              <div class="col-12 text-right">
                <form action="{{ url('/hotspot/user/delete-all') }}" method="POST" onsubmit="return confirm('Yakin hapus semua user?');" style="display:inline-block;">
                  @csrf
                  <button type="submit" class="btn btn-danger">Delete All User</button>
                </form>
              </div>
            </div>
        </div>
